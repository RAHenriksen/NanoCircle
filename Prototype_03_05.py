...
def Complex(bamfile,mapQ,reg, start, end):
    ...
    for read in Read_list:
        ...
        if len(Sing_dict) == 1:
            print("values",list(Sing_dict.values())[0])
...
print(Simple_circ2)
print(type2)
Simple_circ_BED(Simple_circ2,1,"circ_test.bed")
...
Simple_circ_BED(Simple_circ1,2,"circ_test2.bed")
...
"""
dict1 = Single_coord(bamfile,60,"chr5", 121967700, 121972207)
keys = list(list(Simple_circ2.keys())[0])
print(keys)
for i in range(len(keys)):
    print(keys[i])
    print(dict1[keys[i]])
...
#Read_bed(Simple_circ2,1,"lol.bed")

#print(Complex(bamfile,60,"chr1", 243928620, 243938331))
#print(Complex(bamfile,60,"chr5", 121967700, 121972207))
"""
#Type 0: - Empty dict
