...
def CIGAR_int(cig_str):
    """Returns the actual length of the sequence based on the CIGAR int values"""
    return sum(int(x) for x in re.findall(r'[0-9]+', cig_str))
...
"""
dic = Supplement_dict(bamfile,False,60,"chr1", 243928620, 243938331)
for k,v in dic.items():
    print(v)

print("-----------------------")
reduc = reduce_coords(bamfile,False,60,"chr1", 243928620, 243938331)
...
#print(Single_coord(bamfile,False,60,"chr1", 243928620, 243938331))
#print(Single_coord(bamfile,False,60,"chr1", 106597836,106598346))
#Single_coord(bamfile,True,60,"chr1", 243928620, 243938331)

print("--------------------")
#File_identification("BC05.ge_mean5.bdg",True,60)

#print("------------------")
#print(Prim_dict(bamfile, False,60, "chr1", 106597836,106598346))
#print(Single_coord(bamfile,False,60,"chr1", 174736312, 174736815))
#print(Single_coord(bamfile,False,60,"chr1", 106597836,106598346))
