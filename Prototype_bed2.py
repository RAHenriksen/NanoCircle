...
print(Simple_circ2)
print(type2)
Simple_circ_BED(Simple_circ2,1,1,"circ_test.bed","BC05.aln_hg19.bam")
Simple_reads(Simple_circ2,1,coord2,1,"read_test.bed","BC05.aln_hg19.bam")

print("--------------------")
Simple_circ1,type1,coord1,chr1 = Complex(bamfile,60,"chr1", 243928620, 243938331)
print(Simple_circ1)
print(type1, coord1, chr1)
Simple_circ_BED(Simple_circ1,2,2,"circ_test2.bed","BC05.test")
print("--------------------")

Simple_circ3,type3,coord3,chr3 = Complex(bamfile,60,"chr8", 18429880, 18430874)
print(Simple_circ3)
print(type3)
Simple_circ_BED(Simple_circ3,1,1,"circ_test3.bed","BCO5.test")
"""